  ...
  overrideLineWidth:(NSNumber *)overrideLineWidth
{
    ...
    if (self) {
        ...
        _countingLabel = [[UICountingLabel alloc] initWithFrame:CGRectMake(0, 0, 70, 50.0)];
        ...
        [_countingLabel setCenter:CGPointMake(self.frame.size.width/2.0f, self.frame.size.height+20)];
        ...
        _countingImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 59.0, 59.0)];
        _countingImageView.layer.cornerRadius=72/2.0f;
        _countingImageView.clipsToBounds=YES;
        //[_countingImageView setBackgroundColor:[UIColor redColor]];
        [_countingImageView setCenter:CGPointMake(self.frame.size.width/2.0f, self.frame.size.height/2.0f)];
        [self addSubview:_countingImageView];
    }
...
- (void)strokeChart
{
    // Add counting label
     ...
     _countingImageView.image=[UIImage imageNamed:self.imageName];
