...
//  Test
//
//  Created by Macro on 15/11/4.
//  Copyright © 2015年 BlueFocus. All rights reserved.
//
...
+ (NSString*)getWifiName{
    ...
    if (!wifiInfo) {
        ...
        //DLog(@"当前wifi的名称:  %@",networkInfo[(__bridge NSString*)kCNNetworkInfoKeySSID]);
...
+ (NSString*)getWifiMac{
    ...
    if (!wifiInfo) {
        ...
        NSDictionary *networkInfo = (__bridge NSDictionary*)wifiInfo;
        //DLog(@"当前wifi的mac地址为： %@",networkInfo[(__bridge NSString*)kCNNetworkInfoKeyBSSID]);
